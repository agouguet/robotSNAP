...
namespace RobotSNAP
{
    ...
    public class RobotOdomPublisher : MonoBehaviour
    {
        ...
        private void PublishOdometry()
        {
            ...
            // Velocity
            _message.twist.twist.linear = Util.Geometry.GetGeometryVector3(new Vector3(_robot.Velocity.x, 0, 0).To<FLU>());
            _message.twist.twist.angular = Util.Geometry.GetGeometryVector3(new Vector3(0, -_robot.AngularSpeed, 0).To<FLU>());
