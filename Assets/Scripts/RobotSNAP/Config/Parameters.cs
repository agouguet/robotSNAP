...
{
    public const float DESIRED_SPEED = 1.2f;
    public const float PERCEPTION_RADIUS_AGENT = 2.5f;
    public const float T = 0.3f;
    public const float A = 10f; //1500f / 4; //2000
    public const float B = 0.3f; //0.08f * 2;
    public const float K = 1.2E5f;
    public const float KAPPA = 2.4E5f;

    public const float WALL_A = 10f; //600f * 4; // 600
    public const float WALL_B = 0.02f; //0.08
    ...
    public const float MAX_VEL = 1.5f;//0.5f / 0.02f;
